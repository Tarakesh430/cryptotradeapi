...
public class CryptoExchangeService {
    ...
    public List<CryptoExchangeDto> getAllCryptoExchanges() {
        ...
        return Optional.ofNullable(cryptoExchanges).orElse(Collections.emptyList())
                .stream().map(mapper::toDto).collect(Collectors.toList());
    }

    public void validateUserKeys(KeyValidationRequest keyValidationRequest) throws UnsupportedEncodingException,
